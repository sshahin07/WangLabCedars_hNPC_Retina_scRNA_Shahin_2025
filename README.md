...
The raw and processed **single-cell RNA-sequencing** data have been deposited in the **NCBI Gene Expression Omnibus (GEO)**, accession number [GSE295253](https://www.ncbi.nlm.nih.gov/geo/). Please contact the corresponding author of the paper (Shaomei Wang) with any queries related to the dataset.
